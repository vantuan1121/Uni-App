...
<template>
  <div class="flex flex-col h-screen ">
    ...
    <div class="flex-1 overflow-auto mt-4 scroll-container bg-[#111111]" @scroll="onScroll">
      <div v-if="isLoading && !users.length" class="text-center text-white">
      ...
      <div v-else>
        <div v-for="user in users" :key="user.id" class="bg-[#222222] py-4 px-4 mx-2 my-2 rounded-lg shadow-sm cursor-pointer" @click="goToUserDetail(user)">
